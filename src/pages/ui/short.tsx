    ...
    const handleShorten = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setLoaded(true);
                if (data.isDuplicate) {
                    setError('This url shorted before!');
                } else {
                    setError('');
                }
                    ...
                    <div className='flex flex-col justify-center space-y-4 text-center'>
                        ...
                        <div className='w-full max-w-sm space-y-2 mx-auto'>
                            <Input
                                ...
                                value={loading ? 'Processing..' : originalUrl}
                            ...
                            <div className='flex space-x-2'>
                                <Input
                                    ...
                                    minLength={3}
                                    maxLength={8}
                                    placeholder='Enter your custom short name (optional)'
                                    value={loading ? 'Processing..' : loaded ? shortenedUrl : customShortUrl}
